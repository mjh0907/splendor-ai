...
object Param {
  ...
  val MAX_SAFE_COIN_LACK_FOR_RESERVE = Array[Short](4,3,3)
  val RESERVE_COST = Array[Short](0,200,300,400)
  ...
  val BUY_RESERVED_CARD_BONUS = 500
  val MAX_SEARCH_STATES = 100000
  val TRY_RESERVER_COIN_NUM = 8
  var VISIBLE_PUBLIC_CARD_POINT_RATIO = 0.2
